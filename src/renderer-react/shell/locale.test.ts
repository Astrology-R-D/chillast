...
test('contains the exact Task 6 profile editor localization contract', () => {
  expect(Object.fromEntries([
    ...
    'form.saving', 'form.retrySave', 'form.increment', 'form.decrement', 'form.timezoneResolving', 'form.timezoneDerived', 'form.retryTimezone',
    ...
    'form.increment': '{{field}}增加', 'form.decrement': '{{field}}减少',
